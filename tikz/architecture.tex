...
\begin{tikzpicture}
	...
	\draw (0.5,2.5) rectangle node {Base} (3.5,3.5);
	\draw (0.5,3.5) rectangle node [rotate=90] {Bars} (1.5,5.25);
	\draw (1.5,3.5) rectangle node [rotate=90] {Vertical} (2.5,5.25);
	\draw (2.5,3.5) rectangle node [rotate=90] {Pie} (3.5,5.25);

	\draw (5,2.5) rectangle node [rotate=90] {Scales} (6,5.25);
	\draw (6,2.5) rectangle node [rotate=90] {Helper Functions} (7,5.25);

	\draw (0.5, -1.25) rectangle node {OpenSCAD} (4, -0.25);
	\draw (4, -1.25) rectangle node {...} (7.5, -0.25);
